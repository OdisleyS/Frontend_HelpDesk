// src/app/dashboard/meus-chamados/page.tsx
'use client';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <Button onClick={() => window.location.href = '/dashboard/abrir-chamado'}>
          Novo Chamado
        </Button>
      </div>
      ...
      {chamados.length === 0 ? (
        <Card>
          <CardContent className="text-center py-10">
            ...
            <Button className="mt-4" onClick={() => window.location.href = '/dashboard/abrir-chamado'}>
              Abrir Novo Chamado
            </Button>
          </CardContent>
        </Card>
