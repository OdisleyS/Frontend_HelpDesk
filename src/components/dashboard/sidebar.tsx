...
const menuItems = [
  ...
  { icon: TicketsIcon, name: 'Meus Chamados', path: '/dashboard/meus-chamados' },
  { icon: AddIcon, name: 'Abrir Chamado', path: '/dashboard/abrir-chamado' },
  { icon: NotificationIcon, name: 'Notificações', path: '/dashboard/notificacoes' },
  { icon: ProfileIcon, name: 'Meu Perfil', path: '/dashboard/perfil' },
];
